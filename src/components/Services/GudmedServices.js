...
// import { Pill, Calendar, Package, Bell, MessageSquare, RefreshCw, CheckCircle } from 'lucide-react';
...
//       description:
//         "Keeping track of medications is crucial for effective treatment, yet many patients struggle to follow their prescribed schedules. GudMed's Medicine Reminders service ensures that patients never miss a dose, improving compliance and health outcomes.",
//       icon: <Pill className="text-blue-600 w-12 h-12" />,
//       howItWorks: [
//         { text: "Patients receive automated reminders via SMS or WhatsApp for every medication on their prescription.", icon: <MessageSquare className="text-blue-600 w-8 h-8" /> },
//         { text: "Reminders are sent at the right times based on dosage instructions from the doctor.", icon: <Bell className="text-blue-600 w-8 h-8" /> },
//         { text: "Patients can easily confirm that they have taken their medication, providing feedback to doctors and caregivers.", icon: <RefreshCw className="text-blue-600 w-8 h-8" /> },
//       ],
//       benefits: [
//         { text: "Improved Treatment Compliance: Patients are less likely to miss or skip their medications.", icon: <CheckCircle className="text-green-600 w-8 h-8" /> },
//         { text: "Better Health Outcomes: Consistent medication use leads to faster recovery and fewer complications.", icon: <CheckCircle className="text-green-600 w-8 h-8" /> },
//         { text: "Reduced Readmissions: Proper medication adherence lowers the likelihood of patients returning to the hospital due to avoidable issues.", icon: <CheckCircle className="text-green-600 w-8 h-8" /> },
//       ],
//     },
//     {
//       title: "Appointment Follow-Ups",
//       description:
//         "Missed follow-up appointments can disrupt care plans and delay recovery. GudMed's Appointment Follow-Up service ensures patients stay on track with their healthcare by sending timely reminders for scheduled appointments or check-ups.",
//       icon: <Calendar className="text-green-600 w-12 h-12" />,
//       howItWorks: [
//         { text: "Patients receive notifications before their upcoming follow-up appointments, including details about time and location.", icon: <MessageSquare className="text-green-600 w-8 h-8" /> },
//         { text: "Follow-ups are tracked within the hospital's system, ensuring that both patients and healthcare providers are kept in the loop.", icon: <RefreshCw className="text-green-600 w-8 h-8" /> },
//         { text: "In case of rescheduling, patients can easily adjust their appointments through the digital reminder service.", icon: <Bell className="text-green-600 w-8 h-8" /> },
//       ],
//       benefits: [
//         { text: "Increased Attendance: Timely reminders help reduce no-shows, ensuring patients attend crucial follow-up appointments.", icon: <CheckCircle className="text-green-600 w-8 h-8" /> },
//         { text: "Seamless Rescheduling: Patients can reschedule appointments quickly, maintaining care continuity.", icon: <CheckCircle className="text-green-600 w-8 h-8" /> },
//         { text: "Enhanced Patient Satisfaction: Patients feel supported throughout their healthcare journey, improving their overall experience.", icon: <CheckCircle className="text-green-600 w-8 h-8" /> },
//       ],
//     },
//     {
//       title: "Medicine Inventory Management",
//       description:
//         "Managing medicine inventories efficiently is critical for hospitals and pharmacies to meet patient demand. GudMed's Medicine Inventory Management service helps hospitals track and manage their medicine stocks in real time, preventing shortages and ensuring that the right medications are always available.",
//       icon: <Package className="text-yellow-600 w-12 h-12" />,
//       howItWorks: [
//         { text: "GudMed's platform integrates with the hospital or pharmacy's inventory system to monitor stock levels in real-time.", icon: <RefreshCw className="text-yellow-600 w-8 h-8" /> },
//         { text: "Automatic alerts are generated when stock levels are low or when medications are approaching their expiration date.", icon: <Bell className="text-yellow-600 w-8 h-8" /> },
//         { text: "Hospitals and pharmacies can forecast inventory needs based on prescription trends and adjust orders accordingly to avoid overstocking or shortages.", icon: <MessageSquare className="text-yellow-600 w-8 h-8" /> },
//       ],
//       benefits: [
//         { text: "Optimized Stock Levels: Ensure that essential medicines are always available, avoiding last-minute shortages.", icon: <CheckCircle className="text-green-600 w-8 h-8" /> },
//         { text: "Reduced Waste: Manage expiration dates and prevent wastage of medicines nearing expiration.", icon: <CheckCircle className="text-green-600 w-8 h-8" /> },
//         { text: "Better Financial Control: Streamlined inventory management reduces the risk of over-ordering and helps optimize the hospital's budget for medicine supplies.", icon: <CheckCircle className="text-green-600 w-8 h-8" /> },
//       ],
//     },
//   ];

//   return (
//     <div className="bg-gradient-to-br from-blue-50 to-blue-100 py-16 px-4 sm:px-6 lg:px-8">
//       <div className="max-w-7xl mx-auto">
//         <h1 className="text-4xl md:text-5xl font-bold text-center text-blue-900 mb-8">
//           Our Services at GudMed
//         </h1>
//         <p className="text-lg md:text-xl text-center text-blue-700 max-w-4xl mx-auto mb-16">
//           GudMed offers a suite of services designed to enhance healthcare
//           delivery, improve patient engagement, and streamline hospital
//           operations. From medicine reminders to inventory management, our
//           solutions empower hospitals, doctors, and patients to stay connected
