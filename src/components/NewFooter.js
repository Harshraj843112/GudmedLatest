            ...
            <div className="max-w-7xl mx-auto flex flex-col items-center space-y-8">
                ...
                <div className="w-full flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0 lg:space-x-8">
                    ...
                    <div className="text-center lg:text-left">
                        <p>©2024 GudMed. All Rights Reserved.</p>
                        <div className="mt-2">
                    ...
                    <div className="text-center lg:text-right space-y-4">
                        {/* Contact Info */}
                        <div>
                            <a href="tel:+919999196828" className="text-lg text-white flex items-center justify-center lg:justify-end hover:text-gray-300">
                                <i className="fas fa-phone-alt rotate-90"></i>
                                <span className="ml-2">+91-9999196828</span>
                            </a>
                            <p>MON–SAT 10AM–6PM</p>
                            <a href="mailto:cs@gudmed.in" className="text-lg text-white hover:text-gray-300">
                                cs@gudmed.in
                            </a>
                        </div>

                        {/* Social Icons */}
                        <div className="flex justify-center lg:justify-end space-x-4 text-xl">
